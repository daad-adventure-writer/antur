...
For now, just download the contents of this repository and put `antur.py` into a directory of desire. I will create a PyPI package at a later date when I'm confident that ANTUR is stable. The current version `0.1.0` is considered as `beta` release.
